  ...
  >
    <div class="w-full max-w-2xl bg-linear-to-br from-gray-900/95 to-black/95 border border-gray-800 rounded-2xl shadow-2xl shadow-red-900/20 overflow-hidden">
        ...
        <div class="flex items-center justify-between">
          <div class="flex items-center gap-3">
            <div class="w-10 h-10 rounded-lg bg-red-600/20 flex items-center justify-center">
              <Icon name="lucide:user-plus" class="w-5 h-5 text-red-400" />
            </div>
            <div>
              ...
              <p class="text-sm text-gray-400">
                Remplissez les informations du nouveau combattant
              </p>
            </div>
          </div>
          <button
        ...
        >
          ...
          <div class="space-y-3">
            ...
            <div class="flex items-start gap-4">
              <div class="relative">
                ...
                >
                  <Icon name="lucide:user" class="w-10 h-10 text-gray-600" />
                </div>
              </div>
              <div class="flex-1">
                <label class="block">
          ...
          <div class="space-y-4">
            <h3 class="text-sm font-semibold text-gray-300 flex items-center gap-2">
              <Icon name="lucide:user" class="w-4 h-4 text-red-400" />
            ...
            <div class="space-y-4">
              <Input
                ...
                required
                hint="Le nom officiel du combattant"
              />
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div class="space-y-2">
                <label class="block text-sm font-semibold text-gray-200">
                  Catégorie de poids <span class="text-red-500">*</span>
                </label>
                <select
                  v-model="form.weight"
                  required
                ...
                >
                  ...
                  <option value="Poids mouche">Poids mouche (57 kg)</option>
                  <option value="Poids coq">Poids coq (61 kg)</option>
                  <option value="Poids plume">Poids plume (66 kg)</option>
                  <option value="Poids léger">Poids léger (70 kg)</option>
                  <option value="Poids welter">Poids welter (77 kg)</option>
                  <option value="Poids moyen">Poids moyen (84 kg)</option>
                  <option value="Poids lourd léger">Poids lourd léger (93 kg)</option>
                  <option value="Poids lourd">Poids lourd (120 kg)</option>
                </select>
                <p class="text-xs text-gray-400">
                  Catégorie officielle UFC
                </p>
              </div>
              <Input
                ...
                placeholder="Ex: 1"
                required
                hint="Position dans le classement"
                min="1"
              />
            </div>
          </div>
          ...
          <div class="space-y-4">
            <h3 class="text-sm font-semibold text-gray-300 flex items-center gap-2">
              <Icon name="lucide:trophy" class="w-4 h-4 text-red-400" />
              Palmarès
            </h3>
          ...
          <div class="space-y-4">
            <h3 class="text-sm font-semibold text-gray-300 flex items-center gap-2">
              <Icon name="lucide:zap" class="w-4 h-4 text-red-400" />
              Statistiques
            </h3>
            <div class="grid grid-cols-2 gap-4">
              <Input
                ...
                placeholder="0"
                required
                hint="Nombre de victoires par K.O."
                min="0"
              />
              <Input
                ...
                placeholder="0"
                required
                hint="Nombre de victoires par soumission"
                min="0"
              />
            </div>
          </div>
      ...
      <div class="px-6 py-4 border-t border-gray-800 bg-gray-900/40 flex items-center justify-end gap-3">
        ...
        <button
          type="button"
          class="px-5 py-2.5 bg-red-600 hover:bg-red-500 text-white rounded-lg font-semibold transition-colors shadow-lg shadow-red-900/40 inline-flex items-center gap-2"
          @click="submit"
        >
