        ...
        <div class="flex items-center justify-between">
          <div class="flex items-center gap-3">
            <div class="w-10 h-10 rounded-lg bg-blue-600/20 flex items-center justify-center">
              <Icon name="lucide:edit" class="w-5 h-5 text-blue-400" />
            </div>
            <div>
        ...
        >
          ...
          <div class="space-y-4">
            <h3 class="text-sm font-semibold text-gray-300 flex items-center gap-2">
              <Icon name="lucide:user" class="w-4 h-4 text-blue-400" />
          ...
          <div class="space-y-4">
            <h3 class="text-sm font-semibold text-gray-300 flex items-center gap-2">
              <Icon name="lucide:trophy" class="w-4 h-4 text-blue-400" />
              Palmarès
            </h3>
          ...
          <div class="space-y-4">
            <h3 class="text-sm font-semibold text-gray-300 flex items-center gap-2">
              <Icon name="lucide:zap" class="w-4 h-4 text-blue-400" />
              Statistiques
            </h3>
